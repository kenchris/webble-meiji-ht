...
class HTListItem extends LitElement {
  static properties = {
...
customElements.define("ht-list-item", HTListItem);

let demoCounter = 0;
let menu;

class HTView extends LitElement {
  static styles = css`
    :host {
      width: 100vw;
      display: flex;
  ...
  async _onreading(reading) {
    ...
    if (!monitor) {
      monitor = document.createElement("ht-list-item");
...
customElements.define("ht-view", HTView);