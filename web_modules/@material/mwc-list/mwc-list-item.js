import{_ as t}from"../../common/tslib.es6-ed95dd19.js";import{h as e}from"../../common/lit-html-01826b4e.js";import{query as i,queryAsync as r,property as a,internalProperty as o,LitElement as s,css as c,customElement as n}from"../../lit-element.js";import"../../common/foundation-5da43da3.js";import"../../common/base-element-da29a93c.js";import"../../common/foundation-92d36b64.js";import"../../common/class-map-5937e1bf.js";import{R as l}from"../../common/ripple-handlers-118ab6e2.js";import{o as m}from"../../common/observer-8c5412ba.js";
/**
 @license
 ...
 */class h extends s{constructor(){super(...arguments),this.value="",this.group=null,this.tabindex=-1,this.disabled=!1,this.twoline=!1,this.activated=!1,this.graphic=null,this.hasMeta=!1,this.noninteractive=!1,this.selected=!1,this.shouldRenderRipple=!1,this.boundOnClick=this.onClick.bind(this),this._firstChanged=!0,this._skipPropRequest=!1,this.rippleHandlers=new l(()=>(this.shouldRenderRipple=!0,this.ripple)),this.listeners=[{target:this,eventNames:["click"],cb:()=>{this.onClick()}},{target:this,eventNames:["mouseenter"],cb:this.rippleHandlers.startHover},{target:this,eventNames:["mouseleave"],cb:this.rippleHandlers.endHover},{target:this,eventNames:["focus"],cb:this.rippleHandlers.startFocus},{target:this,eventNames:["blur"],cb:this.rippleHandlers.endFocus},{target:this,eventNames:["mousedown","touchstart"],cb:this.rippleHandlers.startPress},{target:this,eventNames:["mouseup","touchend"],cb:this.rippleHandlers.endPress}]}get text(){const t=this.textContent;return t?t.trim():""}render(){const t=this.renderText(),i=this.graphic?this.renderGraphic():e``,r=this.hasMeta?this.renderMeta():e``;return e`
      ${this.renderRipple()}
      ${i}
      ${t}
      ${r}`}renderRipple(){return this.shouldRenderRipple?e`
      <mwc-ripple
        .activated=${this.activated}>
      </mwc-ripple>`:this.activated?e`<div class="fake-activated-ripple"></div>`:e``}renderGraphic(){return e`
      <span class="mdc-list-item__graphic material-icons">
        <slot name="graphic"></slot>
      </span>`}renderMeta(){return e`
      <span class="mdc-list-item__meta material-icons">
        <slot name="meta"></slot>
      </span>`}renderText(){const t=this.twoline?this.renderTwoline():this.renderSingleLine();return e`
      <span class="mdc-list-item__text">
        ${t}
      </span>`}renderSingleLine(){return e`<slot></slot>`}renderTwoline(){return e`
    ...
    `}onClick(){this.fireRequestSelected(!this.selected,"interaction")}fireRequestSelected(t,e){if(this.noninteractive)return;const i=new CustomEvent("request-selected",{bubbles:!0,composed:!0,detail:{source:e,selected:t}});this.dispatchEvent(i)}connectedCallback(){super.connectedCallback(),this.noninteractive||this.setAttribute("mwc-list-item","");for(const t of this.listeners)for(const e of t.eventNames)t.target.addEventListener(e,t.cb,{passive:!0})}disconnectedCallback(){super.disconnectedCallback();for(const t of this.listeners)for(const e of t.eventNames)t.target.removeEventListener(e,t.cb)}firstUpdated(){this.dispatchEvent(new Event("list-item-rendered",{bubbles:!0,composed:!0}))}}t([i("slot")],h.prototype,"slotElement",void 0),t([r("mwc-ripple")],h.prototype,"ripple",void 0),t([a({type:String})],h.prototype,"value",void 0),t([a({type:String,reflect:!0})],h.prototype,"group",void 0),t([a({type:Number,reflect:!0})],h.prototype,"tabindex",void 0),t([a({type:Boolean,reflect:!0}),m((function(t){t?this.setAttribute("aria-disabled","true"):this.setAttribute("aria-disabled","false")}))],h.prototype,"disabled",void 0),t([a({type:Boolean,reflect:!0})],h.prototype,"twoline",void 0),t([a({type:Boolean,reflect:!0})],h.prototype,"activated",void 0),t([a({type:String,reflect:!0})],h.prototype,"graphic",void 0),t([a({type:Boolean})],h.prototype,"hasMeta",void 0),t([a({type:Boolean,reflect:!0}),m((function(t){t?(this.removeAttribute("aria-checked"),this.removeAttribute("mwc-list-item"),this.selected=!1,this.activated=!1,this.tabIndex=-1):this.setAttribute("mwc-list-item","")}))],h.prototype,"noninteractive",void 0),t([a({type:Boolean,reflect:!0}),m((function(t){t?this.setAttribute("aria-selected","true"):this.setAttribute("aria-selected","false"),this._firstChanged?this._firstChanged=!1:this._skipPropRequest||this.fireRequestSelected(t,"property")}))],h.prototype,"selected",void 0),t([o()],h.prototype,"shouldRenderRipple",void 0);
/**
@license
...
See the License for the specific language governing permissions and
limitations under the License.
*/;let p=class extends h{};p.styles=d,p=t([n("mwc-list-item")],p);export{p as ListItem};
